package com.bradox.delin.inventory.dataaccess.entity;
...
import com.bradox.delin.platform.audit.AuditTrack;
import com.bradox.delin.platform.audit.AuditableModel;
import com.bradox.delin.platform.audit.AuditingEntityListener;
import com.bradox.delin.platform.dataaccess.entity.ArchivableEntity;
...
public class ProductEntity extends ArchivableEntity {
    ...
    @Column(name = "source_packaging_id")
    ...
    public void setParentProductId(UUID v) { this.parentProductId = v; }
    public UUID getSourcePackagingId() { return sourcePackagingId; }
    public void setSourcePackagingId(UUID v) { this.sourcePackagingId = v; }
