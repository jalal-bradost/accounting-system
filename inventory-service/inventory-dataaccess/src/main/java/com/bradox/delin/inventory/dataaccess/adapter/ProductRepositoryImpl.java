...
import com.bradox.delin.inventory.dataaccess.entity.ProductEntity;
import com.bradox.delin.inventory.dataaccess.mapper.ProductDataAccessMapper;
import com.bradox.delin.inventory.dataaccess.repository.ProductJpaRepository;
import com.bradox.delin.inventory.dataaccess.repository.StockMoveJpaRepository;
import com.bradox.delin.inventory.dataaccess.repository.StockQuantJpaRepository;
import com.bradox.delin.inventory.dataaccess.repository.StockValuationLayerJpaRepository;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public void updateImage(UUID productId, String imageUrl, String contentType) {
        ProductEntity e = jpa.findById(productId)
                .orElseThrow(() -> new com.bradox.delin.inventory.domain.core.exception.InventoryDomainException(
