...
public class StockPicking extends AggregateRoot<StockPickingId> {
    ...
    /** When true (default), a purchase return proposes a vendor credit note after validate. */
    ...
    public static final class Builder {
        ...
        public Builder toRefund(boolean v) { this.toRefund = v; return this; }
