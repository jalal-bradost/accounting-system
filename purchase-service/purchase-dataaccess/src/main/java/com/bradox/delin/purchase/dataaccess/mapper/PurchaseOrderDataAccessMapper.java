package com.bradox.delin.purchase.dataaccess.mapper;

import com.bradox.delin.purchase.dataaccess.entity.PurPurchaseOrderEntity;
import com.bradox.delin.purchase.dataaccess.entity.PurPurchaseOrderLineEntity;
import com.bradox.delin.purchase.dataaccess.entity.PurPurchaseOrderLineTaxEntity;
...
public class PurchaseOrderDataAccessMapper {
    ...
    public PurchaseOrder entityToDomain(PurPurchaseOrderEntity e) {
        ...
        d.setLocked(e.isLocked());
        d.setAmountUntaxed(e.getAmountUntaxed());
        d.setAmountTax(e.getAmountTax());
        d.setAmountTotal(e.getAmountTotal());
        d.setOrderDiscountType(e.getOrderDiscountType());
        d.setOrderDiscountValue(e.getOrderDiscountValue());
        d.setOrderDiscountPercent(e.getOrderDiscountPercent());
    ...
    public PurPurchaseOrderEntity domainToEntity(PurchaseOrder d, PurPurchaseOrderEntity existingOrNull) {
        ...
        e.setLocked(d.isLocked());
        e.setAmountUntaxed(d.getAmountUntaxed());
        e.setAmountTax(d.getAmountTax());
        e.setAmountTotal(d.getAmountTotal());
        e.setOrderDiscountType(d.getOrderDiscountType());
        e.setOrderDiscountValue(d.getOrderDiscountValue());
        e.setOrderDiscountPercent(d.getOrderDiscountPercent());
        ...
        for (PurchaseOrderLine lineDomain : d.getLines()) {
            ...
            lineEntity.setDiscountType(lineDomain.getDiscountType());
