...
public class VendorPaymentDataAccessMapper {
    ...
    public VendorPayment entityToDomain(PurVendorPaymentEntity e) {
        ...
        d.setPaymentKind(e.getPaymentKind() != null ? e.getPaymentKind() : com.bradox.delin.purchase.domain.core.VendorPaymentKind.PAYOUT);
    ...
    public PurVendorPaymentEntity domainToEntity(VendorPayment d, PurVendorPaymentEntity existingOrNull) {
        ...
        e.setPaymentKind(d.getPaymentKind() != null ? d.getPaymentKind() : com.bradox.delin.purchase.domain.core.VendorPaymentKind.PAYOUT);
