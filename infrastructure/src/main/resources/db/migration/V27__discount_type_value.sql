...
ALTER TABLE pur_purchase_order
    ADD COLUMN IF NOT EXISTS order_discount_type VARCHAR(16) NOT NULL DEFAULT 'PERCENT';
ALTER TABLE pur_purchase_order
    ADD COLUMN IF NOT EXISTS order_discount_value NUMERIC(19, 4) NOT NULL DEFAULT 0;
...
ALTER TABLE pur_purchase_order_line
    ADD COLUMN IF NOT EXISTS discount_value NUMERIC(19, 4) NOT NULL DEFAULT 0;
