...
CREATE TABLE IF NOT EXISTS inv_product(
    ...
    cogs_account_id_override CHAR(36),
    company_id CHAR(36) NOT NULL,
    id CHAR(36) NOT NULL,
    purchase_uom_id CHAR(36),
    stock_input_account_id_override CHAR(36),
    stock_output_account_id_override CHAR(36),
    stock_valuation_account_id_override CHAR(36),
...
CREATE TABLE IF NOT EXISTS inv_product_category(
    ...
    id CHAR(36) NOT NULL,
    parent_id CHAR(36),
    stock_input_account_id CHAR(36),
    stock_output_account_id CHAR(36),
    stock_valuation_account_id CHAR(36),
    archived_by VARCHAR(255),
    name VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS inv_stock_move(
    ...
    purchase_order_line_id CHAR(36),
    sales_order_line_id CHAR(36),
...
CREATE TABLE IF NOT EXISTS inv_warehouse(
    ...
    company_id CHAR(36) NOT NULL,
    id CHAR(36) NOT NULL,
    input_location_id CHAR(36),
    output_location_id CHAR(36),
    stock_location_id CHAR(36),
