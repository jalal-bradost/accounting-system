package com.bradox.delin.sales.dataaccess.mapper;

import com.bradox.delin.sales.dataaccess.entity.SalPricelistEntity;
import com.bradox.delin.sales.dataaccess.entity.SalPricelistItemEntity;
import com.bradox.delin.sales.dataaccess.entity.SalSalesOrderEntity;
import com.bradox.delin.sales.dataaccess.entity.SalSalesOrderLineEntity;
import com.bradox.delin.sales.dataaccess.entity.SalSalesOrderLineTaxEntity;
...
public class SalesOrderDataAccessMapper {
    ...
    public SalesOrder entityToDomain(SalSalesOrderEntity e) {
        ...
        o.setOrderDiscountType(e.getOrderDiscountType());
        o.setOrderDiscountValue(e.getOrderDiscountValue());
        o.setOrderDiscountPercent(e.getOrderDiscountPercent());
        o.setQuotationSentAt(e.getQuotationSentAt());
        o.setConfirmedAt(e.getConfirmedAt());
        o.setCancelledAt(e.getCancelledAt());
        o.setLocked(e.isLocked());
    ...
    public SalSalesOrderEntity domainToEntity(SalesOrder o, SalSalesOrderEntity existingOrNull) {
        ...
        e.setOrderDiscountType(o.getOrderDiscountType());
        e.setOrderDiscountValue(o.getOrderDiscountValue());
        e.setOrderDiscountPercent(o.getOrderDiscountPercent());
        e.setQuotationSentAt(o.getQuotationSentAt());
        e.setConfirmedAt(o.getConfirmedAt());
        e.setCancelledAt(o.getCancelledAt());
        e.setLocked(o.isLocked());
