...
public class SalSalesOrderEntity {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "order_discount_type", nullable = false, length = 16)
    private DiscountType orderDiscountType = DiscountType.PERCENT;

    @Column(name = "order_discount_value", precision = 19, scale = 4, nullable = false)
    private BigDecimal orderDiscountValue = BigDecimal.ZERO;

    @Column(name = "order_discount_percent", precision = 19, scale = 4, nullable = false)
