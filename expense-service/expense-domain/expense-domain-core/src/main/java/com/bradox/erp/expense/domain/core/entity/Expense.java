...
public class Expense {
    ...
    private Expense(Builder b) {
        ...
        this.expenseTypeId = b.expenseTypeId;
    ...
    public void markPosted(UUID journalEntryId) {
        ...
        if (state != ExpenseState.APPROVED) {
            throw new ExpenseDomainException("error.expense.onlyApprovedCanPost", null, "Only draft or approved expenses can be posted");
        }
        if (accountId == null) {
    ...
    public void applyUpdate(String description, UUID productId, UUID accountId, UUID expenseTypeId,
                            UUID employeeId, UUID managerEmployeeId, LocalDate expenseDate, BigDecimal total,
    ...
    public static final class Builder {
        ...
        public Builder expenseTypeId(UUID v) { this.expenseTypeId = v; return this; }
