...
public record CompanyResponse(
        ...
        String logoUrl,
        boolean allowBillWithoutReceipt,
        boolean allowInvoiceWithoutDelivery,
        boolean active) {
    ...
    public static CompanyResponse from(CompanyEntity e) {
        return new CompanyResponse(
                ...
                e.getPeriodLockDate(), e.getLogoUrl(),
                e.isAllowBillWithoutReceipt(), e.isAllowInvoiceWithoutDelivery(),
                e.isActive());
    }
}
