package com.bradox.delin.platform.chatter;

import com.bradox.delin.platform.chatter.ports.RecordAttachmentRepository;
import com.bradox.delin.platform.chatter.ports.RecordFollowerRepository;
...
class ChatterApplicationServiceImpl implements ChatterApplicationService {
    ...
    private ChatterFollowerResponse toFollowerResponse(RecordFollower e) {
        return new ChatterFollowerResponse(
                ...
                e.getPartnerId(), resolveUser(e.getAddedBy()), e.isNotifyOnPost(), e.getCreatedAt());
    }
    ...
    private ChatterAttachmentResponse toAttachmentResponse(RecordAttachment e) {
        return new ChatterAttachmentResponse(
                ...
                e.getPublicUrl(), resolveUser(e.getUploadedBy()), e.getCreatedAt());
    }
    ...
    private String resolveUser(String stored) {
        CompanyContext ctx = companyContextProvider.getIfAvailable();
