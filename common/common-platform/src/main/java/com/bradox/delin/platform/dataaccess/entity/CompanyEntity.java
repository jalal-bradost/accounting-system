package com.bradox.delin.platform.dataaccess.entity;
...
public class CompanyEntity extends ArchivableEntity {
    ...
    /** When true, vendor bills may be created from ordered qty before goods receipt. */
    @Column(name = "allow_bill_without_receipt", nullable = false)
    private boolean allowBillWithoutReceipt = false;
    ...
    public boolean isAllowBillWithoutReceipt() { return allowBillWithoutReceipt; }
    public void setAllowBillWithoutReceipt(boolean allowBillWithoutReceipt) {
        this.allowBillWithoutReceipt = allowBillWithoutReceipt;
    }

    public boolean isAllowInvoiceWithoutDelivery() { return allowInvoiceWithoutDelivery; }
    public void setAllowInvoiceWithoutDelivery(boolean allowInvoiceWithoutDelivery) {
        this.allowInvoiceWithoutDelivery = allowInvoiceWithoutDelivery;
    }
}
