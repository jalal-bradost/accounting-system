...
import com.bradox.delin.platform.settings.CompanyApplicationService;
import com.bradox.delin.platform.settings.CompanyResponse;
import com.bradox.delin.platform.settings.CompanyWriteRequest;
...
public class CompanyController {
    ...
    @RequiresPermission("platform.company.write")
    public ResponseEntity<CompanyResponse> uploadLogo(@PathVariable UUID id,
    ...
    @RequiresPermission("platform.company.write")
    public ResponseEntity<CompanyResponse> deleteLogo(@PathVariable UUID id) {
        return ResponseEntity.ok(service.deleteLogo(id));
    }
