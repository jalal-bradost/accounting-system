package com.bradox.delin.pos.service.domain.dto;
...
public class PosOrderResponse {
    ...
    private List<PosOrderLineResponse> lines = new ArrayList<>();
    private List<PosPaymentResponse> payments = new ArrayList<>();
    ...
    public List<PosOrderLineResponse> getLines() { return lines; }
    public void setLines(List<PosOrderLineResponse> lines) { this.lines = lines != null ? lines : new ArrayList<>(); }
    public List<PosPaymentResponse> getPayments() { return payments; }
    public void setPayments(List<PosPaymentResponse> payments) { this.payments = payments != null ? payments : new ArrayList<>(); }
}
