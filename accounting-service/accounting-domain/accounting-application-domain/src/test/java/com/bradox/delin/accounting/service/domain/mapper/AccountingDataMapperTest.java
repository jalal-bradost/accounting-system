...
class AccountingDataMapperTest {
    ...
    private final AccountingDataMapper mapper = new AccountingDataMapper(emptyCompanyContext());

    private static ObjectProvider<com.bradox.delin.platform.web.CompanyContext> emptyCompanyContext() {
        ObjectProvider<com.bradox.delin.platform.web.CompanyContext> provider = mock(ObjectProvider.class);
    ...
    void createJournalEntryCommandToJournalEntry_usesSequenceOverrideWhenProvided() {
        ...
        CreateJournalEntryCommand cmd = new CreateJournalEntryCommand(
                companyId, journalId, "CMD-SEQ", LocalDate.of(2025, 1, 15).atStartOfDay(), "USD",
                List.of(
        ...
        assertThat(entry.getDate()).isEqualTo(LocalDate.of(2025, 1, 15).atStartOfDay());
    ...
    void createJournalEntryCommandToJournalEntry_usesCommandSequenceWhenNoOverride() {
        ...
        UUID journalId = UUID.randomUUID();
        CreateJournalEntryCommand cmd = new CreateJournalEntryCommand(
                companyId, journalId, "CMD-SEQ", LocalDateTime.now(), "USD",
                List.of(
