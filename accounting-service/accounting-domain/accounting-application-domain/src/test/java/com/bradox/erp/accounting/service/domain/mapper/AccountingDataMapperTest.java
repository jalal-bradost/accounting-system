package com.bradox.erp.accounting.service.domain.mapper;
...
class AccountingDataMapperTest {
    ...
    private static ObjectProvider<com.bradox.erp.platform.web.CompanyContext> emptyCompanyContext() {
        ObjectProvider<com.bradox.erp.platform.web.CompanyContext> provider = mock(ObjectProvider.class);
