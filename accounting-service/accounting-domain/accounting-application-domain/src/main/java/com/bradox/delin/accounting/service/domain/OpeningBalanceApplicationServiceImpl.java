...
import com.bradox.delin.accounting.service.domain.create.OpeningBalanceLine;
...
import com.bradox.delin.accounting.service.domain.ports.input.service.OpeningBalanceApplicationService;
...
class OpeningBalanceApplicationServiceImpl implements OpeningBalanceApplicationService {
    ...
    public OpeningBalanceResponse setOpeningBalances(OpeningBalanceCommand command) {
        ...
        CreateJournalEntryCommand createCommand = new CreateJournalEntryCommand(
                command.getCompanyId(), openingJournalId, null, JournalEntryTiming.ofBusinessDate(command.getDate()),
