package com.bradox.delin.accounting.service.domain.mapper;

import com.bradox.delin.accounting.service.domain.create.*;
import com.bradox.delin.domain.core.ValueObject.*;
...
import com.bradox.delin.domain.valueobject.MonetaryScale;
...
public class AccountingDataMapper {
    ...
    public AccountingDataMapper(ObjectProvider<CompanyContext> companyContextProvider) {
    ...
    private static Currency toCurrency(String code) {
        ...
        return new Currency(code.trim().toUpperCase(), "", 2);
    }
}
