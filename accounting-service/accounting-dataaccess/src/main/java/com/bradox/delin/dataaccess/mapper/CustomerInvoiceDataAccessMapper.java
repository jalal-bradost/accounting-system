...
import com.bradox.delin.dataaccess.entity.AccCustomerInvoiceEntity;
import com.bradox.delin.dataaccess.entity.AccCustomerInvoiceLineEntity;
import com.bradox.delin.dataaccess.entity.AccCustomerInvoiceLineTaxEntity;
...
public class CustomerInvoiceDataAccessMapper {
    ...
    private CustomerInvoiceLine lineEntityToDomain(AccCustomerInvoiceLineEntity entity) {
        ...
        line.setDiscountType(entity.getDiscountType());
        line.setDiscountValue(entity.getDiscountValue());
