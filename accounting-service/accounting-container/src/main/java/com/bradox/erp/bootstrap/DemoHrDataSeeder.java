...
import com.bradox.erp.hr.service.domain.dto.CreateEmployeeCommand;
...
public class DemoHrDataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        var existing = employeeService.search(
                new com.bradox.erp.domain.valueobject.CompanyId(COMPANY_ID),
    ...
    private static com.bradox.erp.hr.service.domain.dto.UpdateDepartmentCommand updateDeptManager(UUID managerId) {
        var cmd = new com.bradox.erp.hr.service.domain.dto.UpdateDepartmentCommand();
        cmd.setManagerId(managerId);
        return cmd;
    }

    private static com.bradox.erp.hr.service.domain.dto.UpdateDepartmentCommand updateDeptManagerAndParent(
