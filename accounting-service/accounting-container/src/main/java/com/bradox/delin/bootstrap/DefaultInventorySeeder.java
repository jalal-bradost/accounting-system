...
import com.bradox.delin.inventory.domain.core.valueobject.UomType;
 ...
 *   <li>Default warehouse {@code WH} with auto-provisioned Stock location.</li>
...
public class DefaultInventorySeeder implements ApplicationRunner {
    ...
    private void seedWarehouseAndLocations() {
        ...
        // Auto-provision Stock location and link it.
        ...
        // Optional quarantine bay under the warehouse (INTERNAL).
        ensureLocation(warehouse.getId(),
                DEFAULT_WAREHOUSE_CODE + "/Quarantine", "Main Warehouse / Quarantine", LocationType.INTERNAL);
