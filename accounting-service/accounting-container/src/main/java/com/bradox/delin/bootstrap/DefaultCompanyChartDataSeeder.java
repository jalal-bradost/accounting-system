...
public class DefaultCompanyChartDataSeeder implements ApplicationRunner {
    ...
    private void seedAccounts() {
        ...
        insertAccount("430011", "Stock Input (GR/IR)", AccountType.CURRENT_ASSETS);
        ...
        insertAccount("430021", "Expenses", AccountType.EXPENSES);
    }
    ...
    private void seedJournals() {
        ...
        insertJournal("EXP", "Expense", JournalType.MISC);
    }
