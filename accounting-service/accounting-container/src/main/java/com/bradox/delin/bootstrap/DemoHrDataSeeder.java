...
import com.bradox.delin.hr.service.domain.dto.CreateDepartmentCommand;
import com.bradox.delin.hr.service.domain.dto.CreateEmployeeCommand;
import com.bradox.delin.hr.service.domain.ports.input.DepartmentApplicationService;
...
public class DemoHrDataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        var existing = employeeService.search(
                new com.bradox.delin.domain.valueobject.CompanyId(COMPANY_ID),
    ...
    private static com.bradox.delin.hr.service.domain.dto.UpdateDepartmentCommand updateDeptManager(UUID managerId) {
        var cmd = new com.bradox.delin.hr.service.domain.dto.UpdateDepartmentCommand();
        cmd.setManagerId(managerId);
        return cmd;
    }

    private static com.bradox.delin.hr.service.domain.dto.UpdateDepartmentCommand updateDeptManagerAndParent(
