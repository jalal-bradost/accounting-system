...
/**
 * Bootstrap defaults for {@link com.bradox.delin.bootstrap.DefaultCompanyCurrencySeeder}.
 * Base currency defaults are configured under {@code accounting.currencies.base}.
 */
