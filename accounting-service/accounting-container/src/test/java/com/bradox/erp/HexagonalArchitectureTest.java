...
class HexagonalArchitectureTest {
    ...
    void restControllersMustNotDependOnDataaccess() {
        ArchRule rule = noClasses()
                ...
                .and().resideOutsideOfPackage("com.bradox.erp.platform..")
    ...
    void boundedContextsMustNotImportForeignDataaccess() {
        ...
        for (String source : contexts) {
            for (String target : contexts) {
                ...
                ArchRule rule = noClasses()
                        .that().resideInAnyPackage("com.bradox.erp." + source + "..")
                        .should().dependOnClassesThat()
                        .resideInAnyPackage("com.bradox.erp." + target + ".dataaccess..")
                        .allowEmptyShould(true);
                rule.check(classes);
            }
        }
