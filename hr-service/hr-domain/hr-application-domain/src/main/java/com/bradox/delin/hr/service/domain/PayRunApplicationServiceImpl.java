...
import com.bradox.delin.hr.domain.core.entity.PayRun;
import com.bradox.delin.hr.domain.core.entity.Payslip;
import com.bradox.delin.hr.domain.core.entity.PayslipLine;
import com.bradox.delin.hr.domain.core.exception.HrDomainException;
import com.bradox.delin.hr.domain.core.service.PayrollDomainService;
import com.bradox.delin.hr.domain.core.service.PayrollDomainService.PayslipComputationInput;
import com.bradox.delin.hr.domain.core.service.PayrollDomainService.SalaryRuleInput;
import com.bradox.delin.hr.service.domain.dto.payroll.PayrollApi.*;
import com.bradox.delin.hr.service.domain.ports.input.PayRunApplicationService;
import com.bradox.delin.hr.service.domain.ports.output.accounting.CompanyCurrencyPort;
import com.bradox.delin.hr.service.domain.ports.output.payroll.PayRunRepository;
import com.bradox.delin.hr.service.domain.ports.output.payroll.PayrollPersistence;
import com.bradox.delin.hr.service.domain.ports.output.payroll.PayrollPersistence.*;
...
class PayRunApplicationServiceImpl implements PayRunApplicationService {
    ...
    public PayRunResponse postRun(UUID id) {
        ...
        CreateJournalEntryCommand jcmd = new CreateJournalEntryCommand(
                ...
                payJournalId,
                "",
                JournalEntryTiming.ofBusinessDate(payRun.getPeriodEnd()),
                currencyCode,
                null,
                items);
    ...
    public PayRunResponse payRun(UUID id, PayRunCommand cmd) {
        ...
        CreateJournalEntryCommand jcmd = new CreateJournalEntryCommand(
                ...
                JournalEntryTiming.ofBusinessDate(paymentDate),
                currencyCode,
                null,
                items);
