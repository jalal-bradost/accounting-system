...
import com.bradox.delin.hr.domain.core.entity.LeaveRequest;
import com.bradox.delin.hr.domain.core.entity.TimeOffType;
import com.bradox.delin.hr.domain.core.exception.HrDomainException;
import com.bradox.delin.hr.domain.core.valueobject.*;
import com.bradox.delin.hr.service.domain.dto.EmployeeDisplayMeta;
import com.bradox.delin.hr.service.domain.dto.timeoff.TimeOffApi.*;
import com.bradox.delin.hr.service.domain.ports.input.TimeOffApplicationService;
import com.bradox.delin.hr.service.domain.ports.output.repository.*;
...
class TimeOffApplicationServiceImpl implements TimeOffApplicationService {
    ...
    public TeamSummaryResponse teamSummary(CompanyId companyId, UUID managerId, LocalDate date) {
        ...
        List<com.bradox.delin.hr.domain.core.entity.Employee> employees =
