...
public interface EmployeeJpaRepository extends JpaRepository<EmployeeEntity, UUID> {
    ...
    Optional<EmployeeEntity> findByCompanyIdAndUserId(UUID companyId, UUID userId);

    List<EmployeeEntity> findByCompanyIdAndActiveTrueOrderByDisplayNameAsc(UUID companyId);
}
